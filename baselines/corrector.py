...
"""
import sys
sys.path.append("/home/dgl/project/text_repair/scRNN/")
import os
import torch
from torch.autograd import Variable
# elmo related imports
from allennlp.modules.elmo import batch_to_ids
from baselines.scrnn_utils import *
from baselines import scrnn_utils as utils
...
class ScRNNChecker(object):
    ...
    def report_statistics(self):
        print("Total number of words predicted by background model = %0.2f " % (
                100. * self.predicted_unks / self.total_predictions))
        print("Total number of in vocab words predicted by background model = %0.2f " % (
                100. * self.predicted_unks_in_vocab / self.total_predictions))
