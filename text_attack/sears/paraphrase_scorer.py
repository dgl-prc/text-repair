...
DEFAULT_TO_PATHS = [os.path.join(PROJECT_ROOT,"text_attack/sears",mp) for mp in DEFAULT_TO_PATHS]
DEFAULT_BACK_PATHS = [os.path.join(PROJECT_ROOT,"text_attack/sears",mp) for mp in DEFAULT_BACK_PATHS]
